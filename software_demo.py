...
class ImageSuperResolutionApp:
    def __init__(self, master):
        ...
        self.model_path = 'C:/Users/28958/Desktop/网络部署/liif-single-software/checkpoint/epoch-300.pth'
        ...
        if self.image_path:
            ...
            for i in range(0, h, chunk_size):
                for j in range(0, w, chunk_size):
                    ...
                    model = models.make(load(self.model_path)['model'], load_sd=True).cuda()
            ...
            output_image = output_image.resize((256, 256), Image.BICUBIC)
