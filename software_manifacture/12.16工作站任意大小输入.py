...
class ImageSuperResolutionApp:
    def __init__(self, master):
        ...
        self.model_path = 'D:/liif-main/checkpoint/200/epoch-200.pth'
    ...
    # Inside the ImageSuperResolutionApp class
    def zoom_image(self):
        if self.image_path:
            ...
            # Calculate the zoomed resolution based on the input image size and zoom factor
